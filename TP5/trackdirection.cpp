...
struct EarthProgram {
    ...
    EarthProgram(const FilePath& applicationPath):
        m_Program(loadProgram(applicationPath.dirPath() + "shaders/3D_130.vs.glsl",
...
int main(int argc, char** argv) {
    ...
    DELETE THIS PART IF YOU'RE VERSION 330
    ********************************/
    GLuint test = LoadShader("/home/administrateur/Documents/Projet/GLImac-Template/TP5/shaders/3D_130.vs.glsl", "/home/administrateur/Documents/Projt/GLImac-Template/TP5/shaders/normals.fs.glsl");
    glUseProgram(test);
    /********************************
    END - IF YOU'RE USING GLSL VERSION 130
    ********************************/
    ...
    while(!done) {
        ...
        while(windowManager.pollEvent(e)) {
            ...
            if(windowManager.isMouseButtonPressed(SDL_BUTTON_RIGHT)) {
              ...
              if(deplacementX != 0) {
                 tBCamera.rotateLeft(-deplacementX);
               }
              //si souris bouge verticalement
              if(deplacementY != 0) {
                tBCamera.rotateUp(-deplacementY);
              }
            }
        }
         ...
         *********************************/
         ...
         //envoie des matrices au shader pour TERRE
          ...
          //calcul direction de la source de lumière
          glm::vec4 directLightEarth = glm::vec4(1, 1, 1, 0);
          glm::mat4 rotaMatrixLightEarth = glm::rotate(glm::mat4(1.0f),
            glm::radians(windowManager.getTime())*25, glm::vec3(0, 1, 0));
          directLightEarth = directLightEarth * rotaMatrixLightEarth;
          directLightEarth = ViewMatrix * directLightEarth;

          glUniform3f(earthProgram.uLightDir_vs, directLightEarth.x,
            directLightEarth.y, directLightEarth.z);
          glUniform3f(earthProgram.uLightIntensity, 5, 1, 5);
         ...
         /*glm::vec4 directLightMoon = glm::vec4(-1, -1, -1, 0);
         glm::mat4 rotaMatrixMoon = glm::mat4(1.0f);
         rotaMatrixMoon = glm::rotate(rotaMatrixMoon, glm::radians(windowManager.getTime())*25, glm::vec3(1, 0, 0));
         directLightMoon = directLightMoon * rotaMatrixMoon;
         directLightMoon = ViewMatrix*directLightMoon;*/

         glUniform3f(moonProgram.uLightDir_vs, directLightEarth.x,
            directLightEarth.y, directLightEarth.z);
         glUniform3f(moonProgram.uLightIntensity, 5, 5, 1);
